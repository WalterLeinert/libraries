...
export class ColumnTypes {
   ...
   */
  public static determineTypeFromFunction(type: Funktion): ColumnType {
    if (type instanceof Date) {
      ...
      const typeName = (type as any as Funktion).name.toLowerCase();
      switch (typeName) {
        case 'number':
  ...
  public static typeToString(type: Funktion): string {
